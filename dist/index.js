...
var Map_Map = function Map(_ref) {
  var center = _ref.center,
      ...
      children = _ref.children;
  console.log('zoom', defaultZoom, 'center', center);
...
function (_Component) {
  ...
  function SearchBox(props) {
    ...
    _this.input = react_default.a.createRef();
    _this.autocomplete = null;

    _this.onLoad = function (autocomplete) {
      _this.autocomplete = autocomplete;
    };

    _this.onPlaceChanged = function () {
      var _this$props = _this.props,
          input = _this$props.input,
          multipleMarkers = _this$props.multipleMarkers,
          putMarker = _this$props.putMarker;
  ...
  _createClass(SearchBox, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        style: _objectSpread({}, this.defaultSearchStyles)
      })));
    }
  }]);

  return SearchBox;
}(react["Component"]); //const WithScriptSearchBox = withScriptjs(props => <SearchBox {...props} />);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return src_GMap; });
...
/*#__PURE__*/
function (_Component) {
  src_inherits(GMap, _Component);

  function GMap(props) {
    var _this;

    src_classCallCheck(this, GMap);

    _this = src_possibleConstructorReturn(this, src_getPrototypeOf(GMap).call(this, props));
    var _this$props = _this.props,
    ...
    _this.setCenter = function (markerPos) {
      return _this.setState({
        center: markerPos
      });
    };

    _this.putMarkerFromSearch = function (_ref2) {
      ...
      _this.setCenter(markerPos);
    };

    _this.deleteMarker = function (_ref3) {
  ...
  src_createClass(GMap, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          googleKey = _this$props2.googleKey,
          input = _this$props2.input,
          multipleMarkers = _this$props2.multipleMarkers,
          searchable = _this$props2.searchable,
          justShow = _this$props2.justShow;
      var childrenProps = {
        input: input,
        markers: getMarkers(input),
        multipleMarkers: multipleMarkers //loadingElement: <div style={{ height: '100%' }} />,
      ...
      }, !!searchable && react_default.a.createElement(SearchBox_SearchBox, {
        putMarker: !justShow ? this.putMarkerFromSearch : function () {} //deleteMarker={!justShow ? this.deleteMarker : () => { }}
        ,
        input: input //markers={getMarkers(input)}
        ,
        multipleMarkers: multipleMarkers //loadingElement={<div style={{ height: '100%' }} />}
        //containerElement={<div style={{ height: '500px' }} />}
